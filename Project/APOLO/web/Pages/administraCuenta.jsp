                    ...
                    <div class="col-xl-8 col-lg-10 col-12">
                        <div class="header mt-md-5">
                            <div class="header-body">
                                <div class="align-items-center row">
                                    <div class="col">
                                        <h6 class="header-pretitle">Configuración</h6>
                        ...
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group"><label class="mb-1 form-label">Dirección de correo electronico</label><small
                                            class="small text-muted form-text">Es el metodo para que nos contactemos contigo,
                                            por lo que debes tener cuidado con la dirección que pongas.</small><input type="email"
                            ...
                            <div class="justify-content-between row">
                                <div class="col-12 col-md-6 col-md-6 col-12">
                                    ...
                                    <p class="small text-muted mb-md-0">Eliminar tu cuenta es una acción
